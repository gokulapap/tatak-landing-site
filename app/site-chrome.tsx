 ...
 *
 * What is left is the eight pages behind this one, all of them on this site.
 * The QR sticker sheet used to be the exception - two pages generated by
 * the app and served from app.tatak.tech - and is not any more: it is
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-legal">
        <p>Tatak is an independent hackathon prototype. It is not affiliated with, endorsed by or operated by BMTC, BMRCL or any government body. Tickets shown in the prototype are specimens and are not valid for travel. The QR stickers on this site are sample vehicles from Tatak&apos;s fixture fleet, not real buses or coaches.</p>
