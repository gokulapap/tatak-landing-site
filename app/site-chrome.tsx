...
/**
 * The in-page anchors that used to sit in front of these are gone. They
 * pointed at sections of the page a visitor is already scrolling through,
 * so they earned a slot in the header by describing the page rather than by
 * taking anyone anywhere new.
 *
 * What is left is the six things a visitor cannot reach by scrolling: the
 * sticker sheet, and the five pages behind this one.
 *
